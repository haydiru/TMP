...
class TravelerPosting extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            'id' => 'ID',
            'id_user' => 'Id User',
            'id_negara_asal' => 'Id Negara Asal',
            'id_prov_asal' => 'Id Prov Asal',
            'id_kab_asal' => 'Id Kab Asal',
            'id_kec_asal' => 'Id Kec Asal',
            'id_negara_destinasi' => 'Id Negara Destinasi',
            'id_prov_destinasi' => 'Id Prov Destinasi',
            'id_kab_destinasi' => 'Id Kab Destinasi',
            'id_kec_destinasi' => 'Id Kec Destinasi',
            'id_travel_frek' => 'Id Travel Frek',
